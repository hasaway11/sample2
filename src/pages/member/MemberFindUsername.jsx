  ...
  return (
    <div>
      ...
      <div style={{height:200}}>
        <TextField label='이메일' name='email' value={vEmail.value} message={vEmail.message} onChange={vEmail.onChange} onBlur={onBlur} />
      ...
      <BlockButton label={status===AsyncStatus.SUBMITTING ? "찾는 중..." : "아이디 찾기"} onClick={handleFindUsername} styleName='dark' disabled={status===AsyncStatus.SUBMITTING} />
    </div>
  )
}
